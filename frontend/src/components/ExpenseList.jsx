...
const styles = {
  ...
  badgeOverdue: { background: '#fff1f0', color: '#cf1322', padding: '0.2rem 0.6rem', borderRadius: '12px', fontSize: '0.8rem' },
  badgeCancelled: { background: '#f5f5f5', color: '#595959', padding: '0.2rem 0.6rem', borderRadius: '12px', fontSize: '0.8rem' },
